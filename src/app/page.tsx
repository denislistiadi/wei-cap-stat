...
export default function HomePage() {
  const { inputText, setInputText, captions, isLoading, isCopied, generateCaptions, handleCopy } =
    useCaptionGenerator();
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#f9f7fe] to-[#eef4ff] dark:from-[#0f0c29] dark:to-[#302b63] p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          ...
          <ResultsCard captions={captions} isLoading={isLoading} isCopied={isCopied} handleCopy={handleCopy} />
        </div>
